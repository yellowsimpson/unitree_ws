...
UNITREE_MODEL_DIR = "/home/deepet/unitree_ws/unitree_model/"  # Replace with the actual path to your unitree_model directory
UNITREE_ROS_DIR = ""  # Replace with the actual path to your unitree_ros package
